...
exports.registerValidator = [
    ...
    body('name').isLength({min: 2, max: 15}).withMessage('Имя должно содержать от 2 до 15 символов'),
    body('surname').isLength({min: 2, max: 15}).withMessage('Фамилия должна содержать от 2 до 20 символов'),
